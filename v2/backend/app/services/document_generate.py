...
- Обязательно первыми пунктами: причина поиска/ухода;
- Обязательно последними пунктами: что вдохновляет; что расстраивает; рекомендации/обратная связь прошлых работодателей.
- Остальное посередине опросника — hard skills / опыт / soft skills из профиля.
