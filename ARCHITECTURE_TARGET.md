# Архитектура hr_ai_agent — целевая версия (v2)

> **Это планируемая архитектура, не описание текущего кода.**  
> Текущая рабочая система (Streamlit + JSON + Telegram polling) — в  
> **[`ARCHITECTURE.md`](./ARCHITECTURE.md)**

Документ фиксирует согласованные решения: мультитенантность, фоновые задачи, уведомления о прогрессе, универсальный messaging gateway, миграция со Streamlit без dual-write.
